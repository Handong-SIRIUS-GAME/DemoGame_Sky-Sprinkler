...
1. Clone the repo  
   ```bash
   git clone https://github.com/Handong-SIRIUS-GAME/DemoGame_Sky-Sprinkler.git
   
2. Open in Unity version 6000.0.57f1. (Other version may work too as there are not much features)
